...
console.log(calculateTip(5, 100))
...
var tipAmount = prompt("What is your tip percentage?")
function billAndTip() {
    return calculateTip(tipAmount, billTotal);
}

// The function below is for the last question.
